...
class AuthViewModelImpl(private val loginUseCase: LoginUseCase, private val registerUseCase: RegisterUseCase, private val getUserNameUseCase: GetUserNameUseCase, private val getTokenUseCase: GetTokenUseCase, private val authSaveTokenUseCase: AuthSaveTokenUseCase) : AuthViewModel, ViewModel() {
